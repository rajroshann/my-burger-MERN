...
import { API } from '../service/api'
  ...
  async function Order(burgerId){
    ...
    if(res.isSuccess){
      alert(' successfully ordered your burger')
    }
}
    ...
    return (
      <div className="bg-green-500">
        <div className="mx-auto max-w-2xl px-4 py-16 sm:px-6 sm:py-24 lg:max-w-5xl lg:px-8">
          <h2 className="text-3xl font-bold tracking-tight text-gray-700">ORDER Your delicious BURgerrr</h2>
            ...
            {products?.map((product) => (
              <div key={product._id} className="group relative">
                ...
                <div className='flex justify-center space-x-2'>
                    ...
                    className={`${isAdmin==='true'?'hidden':'block'} px-8 py-1 rounded-full bg-purple-400 text-lg font-semibold hover:bg-blue-300 text-white`} >ORDer </button>
