...
<div className="flex md:flex-row flex-col justify-center max-w-6xl m-4 ">
    <div className="lg:w-1/2 bg-purple-700 ">
        <div className="flex justify-center flex-col items-center">
            <div className="text-white m-6 text-xl z-200"> CONTACT </div>
            <div className="text-white p-5 z-200"> WE  are here for u ! </div>
            <div className="text-white m-6 z-200">
                <div className="flex m-2">
                    <ion-icon name="person-outline" className="m-"></ion-icon> <input placeholder=" ENTER Name"
                        className="bg-purple-300  p-2 rounded-3xl"/>
                </div>
                <div className="flex m-2">
                ...
                <div className="flex m-2">
                    <ion-icon name="call-outline" className="m"></ion-icon> <input placeholder="PHOne NO"
                        className="bg-purple-300  p-2 rounded-3xl"/>
                </div>
                <div className="flex m-2">
                    <ion-icon name="create-outline" className="m-"></ion-icon> <input
                        placeholder="TYPE SOmething" className="bg-purple-300  p-2 rounded-3xl"/>
                </div>
                <div className="block m-2justify-center">
                    <div className="bg-red-300 p-2 rounded-3xl hover:bg-gray-500  cursor-pointer ">
